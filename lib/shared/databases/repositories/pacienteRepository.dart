...
class PacientesCadastradosRepository {
  ...
  Future<void> atualizar(
    ...
    return _dbFirebase.atualizar(paciente.toMap(), id);
  }

  Future<void> remover(CadastroPaciente pacienteDeletado) async {}

  Future<Map<String, dynamic>?> selecionar(
      String cpf, String rg, String numeroCartaoSus) async {
  ...
  Future<Map<String, dynamic>?> selecionarNumeroCartaoSus(
      String numeroCartaoSus) async {
