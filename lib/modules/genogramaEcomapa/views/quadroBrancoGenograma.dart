  ...
  Widget build(BuildContext context) {
        ...
        if (edicaoAtiva.value) {
          ...
          if (elementoEncontrado != null &&
            ...
            desenhoAtual.value = ElementosDesenho(
              ...
              tamanho: tipoDesenho.value == TipoDesenho.texto ? 8 : 20,
          ...
          if (pontoDeConexaoMaisProximo != Offset.zero) {
            desenhoAtual.value = ElementosDesenho(
              id: id.value != 0 ? id.value : genograma.value.elementos.length + 1,
          ...
          id.value = id.value != 0 ? id.value : genograma.value.elementos.length + 1;
        } else {
          temDesenho.value = true;
          desenhoAtual.value = ElementosDesenho(
            id: id.value != 0 ? id.value : genograma.value.elementos.length + 1,
    ...
    void onPointerUp(PointerUpEvent details) {
      ...
      if (desenhoAtivo.value && temDesenho.value) {
        ...
        id.value = genograma.value.elementos.length + 1;
        ...
        if (
          ...
          (elementoEncontrado.tipo == TipoDesenho.circulo || elementoEncontrado.tipo == TipoDesenho.quadrado) &&
          temIndice.value == false
        ) {
          temDesenho.value = true;
          desenhoAtual.value = elementoEncontrado;
          ...
          // Show dialog to confirm marking as index
          showDialog(
            context: context, 
            builder: (context) {
              return AlertDialog(
                  ...
                  TextButton(
                    onPressed: () {
                      ...
                      desenhoAtual.value = ElementosDesenho(
                        ...
                        tipo: genograma.value.pacienteRaiz['sexo'] == "Masculino" ? TipoDesenho.quadrado : TipoDesenho.circulo,
